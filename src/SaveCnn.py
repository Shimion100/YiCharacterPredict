...
class CnnModel(object):
    ...
    def copyInit(self, fromModel, learning_rate=0.1, dataset='mnist.pkl.gz', nkerns=[20, 50], batch_size=1):
        ...
        self.layer0_input = x.reshape((batch_size, 1, 28, 28))
        ...
        self.layer3.copyInit(input=self.layer2.output, n_in=500, n_out=7,
    ...
    def oriInit(self, learning_rate, dataset='mnist.pkl.gz', nkerns=[20, 50], batch_size=1):
        #Init the params
        self.learning_rate = learning_rate
        print("learning_rate----------------------%",learning_rate)
        self.dataset = dataset
        ...
        self.layer3 = LogisticRegression()
        self.layer3.oriInit(input=self.layer2.output, n_in=500, n_out=7)
